...
### for local testing you should modify the gearbox-matching pyproject.toml by adding "develop=true" as follows which will copy the migrations into the env/src directory 
